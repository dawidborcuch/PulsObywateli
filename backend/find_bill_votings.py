...
def find_bill_votings():
    """Znajdź głosowania nad projektami ustaw"""
    try:
        ...
        for i, voting in enumerate(votings):
            ...
            for vote_num in range(1, voting_num + 1):
                try:
                    ...
                    if details_response.status_code == 200:
                        ...
                        # Szukaj słów kluczowych związanych z projektami ustaw
                        keywords = ['ustawa', 'projekt', 'druk', 'uchwała', 'zmiana ustawy']
                        ...
                        if is_bill_voting:
                            ...
                            print(f"\n=== Znaleziono głosowanie nad projektem ===")
        ...
        print(f"Unikalne numery druków: {unique_druk_numbers[:10]}")
        
        return unique_druk_numbers[:10]
